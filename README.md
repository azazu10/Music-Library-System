...
- *Concept #1*: [Error Handling], *File name / Line numbers(s)*: [main.cpp: 57 (try-catch block); musicLibrary.cpp: 136 (try-catch block)]
- *Concept #2*: [Input Validation], *File name / Line numbers(s)*: [main.cpp: 30 (do-while loop), 40 (do-while loop)]
- *Concept #3*: [File Handling], *File name / Line numbers(s)*: [musicLibrary.cpp: 112 (loadLibraryFromFile function); musicLibrary.cpp: 160 (saveLibraryToFile function)]
- *Concept #4*: [Data Structures], *File name / Line numbers(s)*: [musicLibrary.h: 11 (vector<Song> library)]
- *Concept #5*: [Algorithms], *File name / Line numbers(s)*: [musicLibrary.cpp: 112 (find_if algorithm)]
- *Concept #6*: [Enum Usage], *File name / Line numbers(s)*: [musicLibrary.h: 45 (enum class AddResult)]
- *Concept #7*: [Efficient Searching], *File name / Line numbers(s)*: [musicLibrary.cpp: 158 (find_if algorithm)]
- *Concept #8*: [Case-insensitive Searches], *File name / Line numbers(s)*: [musicLibrary.cpp: 38 (Usage of toLower throughout searchSongs function)]
...
- *Concept #1*: [Encapsulation], *File name / Line numbers(s)*: [main.cpp, musicLibrary.h]
- *Concept #2*: [Abstraction], *File name / Line numbers(s)*: [song.h, musicLibrary.h]
- *Concept #3*: [Polymorphism], *File name / Line numbers(s)*: [musicLibrary.cpp: 112 (Overloading the loadLibraryFromFile function)]
- *Concept #4*: [Modularity], *File name / Line numbers(s)*: [main.cpp, musicLibrary.cpp]
